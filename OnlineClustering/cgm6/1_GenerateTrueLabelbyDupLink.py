...
f_lang = open('stackoverflow_r_id_title_tags', 'r')
...
print("---cluster:postids-----")

for component in networkx.strongly_connected_components(undirected):
#for component in networkx.connected_components(undirected):
  component=list(component) 
  len_comp=len(component) 
  if len_comp not in dic_clussize__count:
    dic_clussize__count[len_comp]=0
  dic_clussize__count[len_comp]+=1	
  ...
  dic_clust__PostIds[components]=component
  print('cluster=',components,len_comp) 
...
f_java_r = open('stackoverflow_r_id_title_tags', 'r')
