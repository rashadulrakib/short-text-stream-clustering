...
# change index
# initialize by gram clustering

#change main.py: AllBatchNum = 700 for r
#change DocumentSet.py: text = body
#change DocumentSet.py: dataDir = r'D:\githubprojects\PyMigrationRecommendation\src\notebooks' \
#                  r'\train_stackoverflow_r_true_id_title_tags_body_createtime '
#change Model.py: clusterWriterFile = 'out_r_body_pred_true_text.txt'
#save output: out_r_body
...
AllBatchNum = 700  # The number of batches you want to devided the dataset to
alpha = 0.03
beta = 0.03
iterNum = 0
sampleNum = 1
